...
export interface PiSpaceSliderProps {
  items: ItemProps[];
...
export default function PiSpaceSlider(props: PiSpaceSliderProps) {
  const { items, rounded } = props;
  return (
    <div className="flex justify-center">
      <div className="w-screen xl:max-w-[1440px]">
        <Carousel
          interval={3000}
          autoPlay
          infiniteLoop
        ...
        >
          {items.map((item, i) => {
            return (
              <div
                className={`relative w-full xl:h-[130px] ${
