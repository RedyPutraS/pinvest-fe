...
const ShareArticle = ({ type = "icon", path = "", className }: Props) => {
  let asset;
  ...
  return (
    <>
      ...
      <Button
        className="flex items-center px-3 text-xs md:text-base"
        color="blue"
        variant="outlined"
      ...
      >
        Bagikan
        <img
          className={cn("z-10 mx-2 md:mx-0 md:ml-5 w-3 cursor-pointer md:w-6", className)}
          src={asset}
          alt="share"
        />
      </Button>
