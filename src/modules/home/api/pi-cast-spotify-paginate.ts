...
export const getPiCastSpotify = async ({
  ...
  const { data } = await axios.get("/picast/spotify/episodes", {
    params: { limit, start, type, search, page },
  });
  return schema.parse(data);
};

export const usePiCastSpotifyPaginate = (params: PiCastSpotifyParams) =>
  useQuery(["piCastSpotifyPaginate", params], () => getPiCastSpotify(params));

usePiCastSpotifyPaginate.prefetch = async (
  queryClient: QueryClient,
  params: PiCastSpotifyParams
) =>
  await queryClient.prefetchQuery(["piCastSpotifyPaginate", params], () =>
