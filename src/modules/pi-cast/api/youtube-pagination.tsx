...
export const usePiCastPaginateYoutube = (params: YoutubeParams) =>
  useQuery(["youtube-playlist", params], () => getPiCastYoutube(params));

usePiCastPaginateYoutube.prefetch = async (
  queryClient: QueryClient,
  params: YoutubeParams
) =>
  queryClient.prefetchQuery(["youtube-playlist", params], () =>
